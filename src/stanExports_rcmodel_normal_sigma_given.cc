...
#include "stanExports_rcmodel_normal_sigma_given.h"

RCPP_MODULE(stan_fit4rcmodel_normal_sigma_given_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_rcmodel_normal_sigma_given")
