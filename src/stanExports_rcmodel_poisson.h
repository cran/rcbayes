...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rcmodel_poisson");
    reader.add_event(80, 78, "end", "model_rcmodel_poisson");
    return reader;
}
#include <stan_meta_header.hpp>
class model_rcmodel_poisson
  : public stan::model::model_base_crtp<model_rcmodel_poisson> {
private:
        int pre_working_age;
        int working_age;
        int retirement;
...
typedef model_rcmodel_poisson_namespace::model_rcmodel_poisson stan_model;
#ifndef USING_R
